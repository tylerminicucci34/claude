...
const STOCK_VOICES = {
  hormozi: { sev:"MEDIUM", diag:"Stocks are not a business. You are buying a piece of someone else's compounding. Build the business — the multiple is yours, not the market's.", yes:"If it cashflows and beats your CAC payback, yes. Otherwise build the business.", no:"Stocks are not where wealth is created — they store it. No.", advice:"Look — personally I'm in private equity through Acquisition.com (Skool, Prestige Labs, Allied Wellness, several SaaS), some BTC, and broad index funds for storage. I am NOT picking individual stocks. Stocks are a savings account with volatility. Real wealth comes from owning the offer, the customer relationship, the operating leverage. Build a business that prints money. That is the play." },
  cardone: { sev:"HIGH", diag:"STOCKS WILL NOT MAKE YOU RICH. You need cash flow. You need real estate. The market is a SLOW LANE.", yes:"10X positions only. Massive action.", no:"Stocks are middle-class thinking. NO.", advice:"Listen — I own over 12,000 multifamily apartment units through Cardone Capital — that's where my money is. I own Bitcoin. I own TESLA (TSLA) — that's the only individual stock I really push. A 401k is a 40-year LOSER plan. The stock market is for storing money, NOT making it. Buy CASHFLOWING REAL ESTATE. Apartments. Multifamily. 10X your income FIRST, then buy assets that cashflow MONTHLY." },
  andrewtate: { sev:"MEDIUM", diag:"Brother, the stock market is rigged. The whales know before you do. You are playing their game in their casino.", yes:"Crypto, gold, real estate — yes. Stocks? Slow.", no:"Matrix paper. No.", advice:"G, my portfolio is Bitcoin (100+ BTC, publicly stated), Romanian real estate, casinos, vintage cars, luxury watches. The Real World prints monthly cash. I don't touch the stock market — it's the matrix's game. The matrix prints the money and inflates the asset. Stack BTC, stack physical gold, build an income stream that pays in cash. Speed is everything, brother." },
  tristantate: { sev:"MEDIUM", diag:"You are buying into a position with no leverage. Retail is the exit liquidity for someone else's plan. Know your role.", yes:"If it serves a long-term strategic position — yes.", no:"Tactical retail trading is for losers. No.", advice:"My portfolio is Bitcoin, casino assets in Eastern Europe, Romanian property, and brand partnerships through The Real World. Position, not prediction. The stock market rewards patience and information asymmetry — retail has neither. Either build a 20-year index position and forget it, or get out of the casino entirely and put capital into businesses you control." },
  buffett: { sev:"LOW", diag:"Most investors lose by trying to be clever. Buy a low-cost S&P 500 index fund. Hold it for fifty years. Charlie agrees.", yes:"If the moat is wide and the price is fair, yes. Hold forever.", no:"I cannot value it. No.", advice:"At Berkshire our biggest position is Apple (AAPL) — well over $170 billion worth. We also hold Bank of America (BAC), American Express (AXP), Coca-Cola (KO) since 1988, Chevron (CVX), Occidental Petroleum (OXY), Moody's (MCO), Kraft Heinz (KHC). We hold them for the moat and the dividends. For 95 percent of people though, the right answer is a low-cost S&P 500 index fund, bought monthly, held for decades. Rule No. 1: never lose money." },
  musk: { sev:"MEDIUM", diag:"Most stock picking is gambling with extra steps. Index funds are the rational default unless you have informational edge.", yes:"If the technology compounds at 10x, yes. Long.", no:"Probability of being right is too low. No.", advice:"My net worth is mostly Tesla (TSLA), SpaceX, xAI, and X. I'm long Dogecoin. Tesla holds Bitcoin on the balance sheet. I don't buy other stocks — I build companies. From first principles: unless you have informational edge, buy the index. If you want individual picks, pick companies with exponentially improving technology — energy, AI, robotics, autonomy. Ten-plus year horizon. Anything shorter is noise." },
  trump: { sev:"MEDIUM", diag:"The market is HUGE. Tremendous. But you need to buy WINNERS. Losers stay losers. Believe me.", yes:"Big winner. Tremendous. Yes.", no:"Total loser. Walk away.", advice:"Look — I have Trump Media (DJT), it's been tremendous. The Trump Organization owns the best real estate in the world — Trump Tower in New York, Mar-a-Lago, the best golf courses, believe me. Now we have Trump crypto coming. Going to be huge. Buy the strong American brands. Buy real estate. They are not making any more land. Believe me." },
  garyv: { sev:"MEDIUM", diag:"You are putting money into Apple instead of building YOUR brand. Your attention is the asset. Bet on yourself.", yes:"If you understand the business — yes.", no:"You don't even use the product. No.", advice:"Listen — I'm long Apple (AAPL) for decades, I was long Twitter / X. I was an early angel in Facebook, Snap, Uber, Coinbase, Tumblr. So yeah, I play the game. But VaynerMedia, VeeFriends, my businesses — that's where the real return is. For most people in their 20s and 30s the BEST investment is yourself, your audience, your distribution. Index funds for the long game, then bet on YOU. That compounds 100x faster." },
  belfort: { sev:"HIGH", diag:"Retail traders lose because they have no system. They chase, they panic, they sell at the bottom. Get a system or get out.", yes:"With a system and discipline — yes.", no:"You are emotional. You will lose. No.", advice:"Look — I sold penny stocks at Stratton Oakmont. I know how this game really works. I own my businesses (Global Motivation, the Straight Line Sales programs), real estate, conservative blue chips, and gold. I am NOT in crypto — I think most of it is a scam. If you trade, define entry, exit, risk per trade, and follow it like religion. Better yet, index it and master sales — that is the close rate you can actually control." },
  robbins: { sev:"LOW", diag:"Most retail investors lose because of state. Fear sells the bottom, greed buys the top. Master your psychology first.", yes:"With the right strategy, yes.", no:"Not in this emotional state. No.", advice:"I wrote MONEY: Master The Game with Ray Dalio, Jack Bogle, Carl Icahn. The All-Weather portfolio handles every economic season: 30% stocks, 40% long-term bonds, 15% intermediate bonds, 7.5% gold, 7.5% commodities. I personally own real estate, sports teams (LA FC, Major League Pickleball), my businesses. Low-cost index funds, dollar-cost average, never panic sell. Master your emotions, automate the investing, focus on producing." },
  goggins: { sev:"MEDIUM", diag:"You are looking for an easy way out. There isn't one. Stock picking is a shortcut and shortcuts make you soft.", yes:"If you accept you might lose it all — yes.", no:"You want the gain without the work. No.", advice:"I don't talk about stocks because I don't play that game. I live below my means, stack cash, simple index funds, ZERO debt. That's it. The stock market is not your savior. The hard work — that's your savior. Stack the index, automate, and stop checking your portfolio every five minutes. Make so much income that the market is irrelevant. Stay hard." },
  martell: { sev:"LOW", diag:"You are trading time for stock charts instead of building systems that compound. Wrong leverage point.", yes:"Index it, automate it, ignore it. Yes.", no:"Active trading is the opposite of buyback. No.", advice:"I built and sold three SaaS companies — Clarity.fm, Spheric Technologies, Flowtown. SaaS Academy runs now. I'm an active angel investing in early SaaS startups — that's where my edge is. For public stocks: I auto-buy a broad index every month and forget it. The buyback principle applies — automate so it does not consume attention. Most founders I coach who beat the market did it by 10x-ing their business income, not picking stocks." },
  andyelliott: { sev:"MEDIUM", diag:"BROTHER. Stocks are not going to change your life. SALES will. Your sales skill compounds 100x faster than NVDA.", yes:"If you have stable income and zero debt — yes.", no:"Your sales game is not at a 10 yet. NO.", advice:"BROTHER, my money goes into The Elliott Group, commercial real estate, and luxury real estate. I don't day-trade stocks because that's not where the money is — your INCOME is. You make 200K a year as a closer, you can buy any stock you want. You make 50K trying to pick NVDA, you stay broke. Bet on yourself. Train every day. THEN park profits in an index and let it compound." },
  kiyosaki: { sev:"HIGH", diag:"The stock market is a paper asset. The rich don't trust paper — they own real estate, businesses, and precious metals. WAKE UP.", yes:"If it is a cashflow asset — yes.", no:"Paper. Fake. No.", advice:"My mantra is SILVER, GOLD, BITCOIN. Physical silver and gold in my hand. Bitcoin in my own wallet. Plus apartment buildings that cashflow monthly, oil and gas that pays royalties, and the Rich Dad Company. Stocks are PAPER — controlled by Wall Street, taxed at every turn, inflated by the Fed. Own assets you can TOUCH. The B and I quadrant builds real wealth — not the stock market." },
  rogan: { sev:"MEDIUM", diag:"It is wild how confident people are about stocks they don't understand. Have you ever talked to a real fund manager? It humbles you.", yes:"I mean, sure — if you believe in the company. Yeah.", no:"That's wild. No.", advice:"I'm not a finance guy. I own Bitcoin, I sold Onnit to Unilever in 2021, I own real estate in Texas, I'm invested in Cameron Hanes' archery business. But the smart investors I've had on the podcast — Ray Dalio, Cliff Asness — all say the same thing: diversify, index funds, long time horizon, don't try to time it. And honestly? Take a fraction and bet on yourself, your skill, your business. That's the real edge, man." }
};
